const dummyText = [
  ...
  'I love donut soufflé shortbread lemon drops dessert cookie bear claw. Dessert cotton candy jujubes candy canes sweet roll oat cake. Cotton candy sesame snaps gummies chocolate cake cake I love. Macaroon dragée tart biscuit danish. Sugar plum tootsie roll fruitcake sugar plum macaroon. Chocolate cake tiramisu dessert sugar plum candy canes lollipop cake powder cake.',
  'Candy canes tiramisu carrot cake tart I love jujubes I love pie jelly beans. Muffin bonbon cake ice cream tootsie roll I love. Muffin gingerbread dragée I love brownie. Halvah sweet roll cake apple pie dragée shortbread. Chupa chups ice cream cheesecake caramels gummi bears croissant muffin croissant liquorice. Lollipop toffee lollipop macaroon cotton candy cheesecake. I love donut dragée pie tart pie. Sesame snaps danish chocolate bar liquorice I love biscuit icing chocolate cake powder.',
];
...
form.addEventListener('submit', function(event){
  ...
  if (isNaN(value) || value <= 0 || value > 11){
    alert('Enter a number betwwen 1 to 11')
